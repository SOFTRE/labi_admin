...
DeptInfoDlg.addSubmit = function() {
    ...
    //提交信息
    var ajax = new $ax(Labi.ctxPath + "/dept/add", function(data){
        Labi.success("添加成功!");
...
DeptInfoDlg.editSubmit = function() {
    ...
    //提交信息
    var ajax = new $ax(Labi.ctxPath + "/dept/update", function(data){
        Labi.success("修改成功!");
        window.parent.Dept.table.refresh();
        DeptInfoDlg.close();
    },function(data){
...
$(function() {
    Labi.initValidator("deptInfoForm", DeptInfoDlg.validateFields);
