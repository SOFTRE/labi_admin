...
(function () {
    ...
    BSTable.prototype = {
        ...
        init: function () {
            ...
            this.btInstance =
                $('#' + tableId).bootstrapTable({
                    ...
                    sortOrder: "desc",     		//排序方式
                    showExport: this.showExport,                     //是否显示导出
                    ...
                    height: this.height===-1?this.getHeight():this.height,
                    icons: {
        ...
        getHeight: function () {
            return document.body.offsetHeight-48-35-40-14-7;
        }
    };
