...
import com.labi.modular.system.warpper.NoticeWrapper;
...
public class NoticeController extends BaseController {
    ...
    public String hello() {
        List<Map<String, Object>> notices = noticeMapper.list(null,Const.TYPE_HTGL);
    ...
    public Object list(String condition) {
        List<Map<String, Object>> list = this.noticeMapper.list(condition,null);
