...
import com.labi.core.template.config.ContextConfig;
import com.labi.core.template.engine.SimpleTemplateEngine;
...
public class CodeController extends BaseController {
    ...
    public Object add(@ApiParam(value = "模块名称",required = true) @RequestParam  String moduleName,
        ...
        LabiTemplateEngine labiTemplateEngine = new SimpleTemplateEngine();
        labiTemplateEngine.setContextConfig(contextConfig);
        labiTemplateEngine.start();
