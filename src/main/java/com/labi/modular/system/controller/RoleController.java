...
import com.labi.common.constant.cache.Cache;
...
import com.labi.core.cache.CacheKit;
import com.labi.core.log.LogObjectHolder;
import com.labi.core.util.Convert;
import com.labi.core.util.ToolUtil;
import com.labi.modular.system.dao.DeptMapper;
import com.labi.modular.system.dao.RoleMapper;
import com.labi.modular.system.dao.UserMapper;
import com.labi.modular.system.model.Dept;
import com.labi.modular.system.model.Role;
import com.labi.modular.system.model.User;
import com.labi.modular.system.service.IRoleService;
import com.labi.modular.system.warpper.RoleWarpper;
...
//        model.addAttribute("pName", ConstantFactory.me().getSingleRoleName(role.getPid()));
    ...
    @ResponseBody
    public Object list(@RequestParam(required = false) String roleName, @RequestParam(required = false) Integer deptId) {
        List<Map<String, Object>> roles = this.roleMapper.selectRoles(super.getPara("roleName"), deptId);
