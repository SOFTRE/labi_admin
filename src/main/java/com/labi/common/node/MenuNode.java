package com.labi.common.node;

import com.labi.common.constant.Const;
import com.labi.common.constant.state.IsMenu;
...
public class MenuNode implements Comparable {
    ...
    public static List<MenuNode> buildTitle(List<MenuNode> nodes) {
        ...
        LabiProperties labiProperties = SpringContextHolder.getBean(LabiProperties.class);
