...
import com.labi.common.constant.dictmap.factory.DictMapFactory;
...
import com.labi.core.util.Contrast;
...
public class LogAop {
    ...
    @Pointcut(value = "@annotation(com.labi.common.annotion.log.BussinessLog)")
