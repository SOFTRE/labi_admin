...
public class ControllerConfig {
    ...
    public void init() {
        ...
        this.packageName = "com.labi.modular." + contextConfig.getModuleName() + ".controller";
        this.controllerPathTemplate = "\\src\\main\\java\\com\\labi\\modular\\" + contextConfig.getModuleName() + "\\controller\\{}Controller.java";
    }
