...
public class LogTaskFactory {
    ...
    public static TimerTask loginLog(final Integer userId,final Integer deptid,final String deptName, final String ip) {
        return new TimerTask() {
            @Override
            public void run() {
                try {
                    LoginLog loginLog = LogFactory.createLoginLog(LogType.LOGIN, userId,deptid,deptName, null, ip);
        ...
        return new TimerTask() {
            ...
            public void run() {
                LoginLog loginLog = LogFactory.createLoginLog(
                        LogType.LOGIN_FAIL, null,null,null, "账号:" + username + "," + msg, ip);
                try {
                    loginLogMapper.insert(loginLog);
                } catch (Exception e) {
    ...
    public static TimerTask exitLog(final Integer userId,final Integer deptid,final String deptName, final String ip) {
        return new TimerTask() {
            @Override
            public void run() {
                LoginLog loginLog = LogFactory.createLoginLog(LogType.EXIT, userId,deptid,deptName, null,ip);
                try {
                    loginLogMapper.insert(loginLog);
                } catch (Exception e) {
