...
RolInfoDlg.showDeptSelectTree = function () {
    Labi.showInputTree("deptName", "deptContent");
};
...
RolInfoDlg.showPNameSelectTree = function () {
    // Labi.showInputTree("pName", "pNameContent");
};
...
RolInfoDlg.addSubmit = function () {
    ...
    //提交信息
    var ajax = new $ax(Labi.ctxPath + "/role/add", function (data) {
        Labi.success("添加成功!");
...
RolInfoDlg.editSubmit = function () {
    ...
    //提交信息
    var ajax = new $ax(Labi.ctxPath + "/role/edit", function (data) {
        Labi.success("修改成功!");
        window.parent.Role.table.refresh();
        RolInfoDlg.close();
    }, function (data) {
...
$(function () {
    Labi.initValidator("roleInfoForm", RolInfoDlg.validateFields);
